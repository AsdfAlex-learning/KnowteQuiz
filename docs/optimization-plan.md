...
| P4 笔记体验 | 目录扫描、阅读器、错题本 | ✅ ~95% | 滚动/图片/降级、分页、模式过滤、导出、搜索、大纲、复习、扫描取消 | index.json |
| P5 测试门禁 | Rust/前端测试、冒烟流程 | ✅ 100% | 47 Rust + 118 前端测试、冒烟脚本、CI/CD、README 备份文档、发布检查清单 | — |
