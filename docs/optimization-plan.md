...
| P4 笔记体验 | 目录扫描、阅读器、错题本 | ✅ ~98% | 滚动/图片/降级、分页、模式过滤、导出、搜索、大纲、复习、盲区标签过滤、扫描取消、工作区切换清理、错题筛选竞态保护 | index.json |
| P5 测试门禁 | Rust/前端测试、冒烟流程 | ✅ 100% | 48 Rust + 124 前端测试、冒烟脚本、CI/CD、README 备份文档、发布检查清单 | — |
